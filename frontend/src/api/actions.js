...
export async function buyOption(writerNftSerial, optionBuyerId) {
  const dynamoResponse = await fetch(
    "https://tq367v24galhpfcbvhgeoa2eeq0uinzr.lambda-url.us-east-1.on.aws/",
    {
      method: "POST",
      headers: {
...
export async function exerciseOption(
  ...
  const dynamoResponse = await fetch(
    "https://axhyufsc4cwflajwucqlkte3cy0ijikz.lambda-url.us-east-1.on.aws/",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function writeOption(
  ...
  const dynamoResponse = await fetch(
    "https://qy44huzg7fod57jkpaqvp7uwi40ojmdz.lambda-url.us-east-1.on.aws/",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function uploadOptionToDynamo(
  serialNumber,
  transactionId,
  writerAccountId,
  tokenId,
  ...
  const dynamoResponse = await fetch(
    "https://ulmpmp4ofacn343malpxfzgxeq0qbwba.lambda-url.us-east-1.on.aws/",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function addBuyerToOptionDynamo(
  buyerId,
  writerNftSerial,
  buyerNftSerial
) {
  const dynamoResponse = await fetch(
    "https://ve4ripes4mgifatczmpjdsjwzm0moslr.lambda-url.us-east-1.on.aws/",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
